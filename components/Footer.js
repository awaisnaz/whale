...
const Footer = () => {
  return (
    <footer className="bg-[#1a1d29] border-t border-gray-800 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Trade anything anywhere with Whale.io!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/buy-crypto" className="text-gray-400 hover:text-white transition-colors text-sm">Buy Crypto</Link></li>
              <li><Link href="/market" className="text-gray-400 hover:text-white transition-colors text-sm">Market</Link></li>
              <li><Link href="/nft" className="text-gray-400 hover:text-white transition-colors text-sm">NFT</Link></li>
              <li><Link href="/trading" className="text-gray-400 hover:text-white transition-colors text-sm">Trading</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Whale. All rights reserved.
          </p>
