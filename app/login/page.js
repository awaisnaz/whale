...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    const generateQRCode = async () => {
      try {
        const url = await QRCode.toDataURL('https://www.cryptowhale.com/login');
        setQrCodeUrl(url);
      } catch (err) {
            ...
            <div className="lg:w-1/2 p-8 lg:p-12">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-400 mb-8">
                  Sign in to your account to continue<br />trading.
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="text-right">
                    <Link href="/forgot-password" className="text-green-500 hover:text-green-400 text-sm transition-colors">
                      Forgot Password?
                    </Link>
                  </div>
